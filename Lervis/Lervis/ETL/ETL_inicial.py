...
try:
    ...
    print(f'Error en la carga de modelos: {e}')
...
try:
    ...
    print(f'Error en la configuracion de la conexion de la BBDD: {e}')
...
try:
    ...
    print(f'Error en la insercion de la dimension categorias: {e}')

try:
    # DF de los metadatos para la extraccion
    metadatos_publicaciones = extraccion_por_categorias(target_por_categoria)
except Exception as e:
    print(f'Error en la consulta API y generacion del df para descarga de documentos: {e}')
...
try:
    ...
    print(f'Error en la insercion y normalizacion de datos de la BBDD: {e}')
...
for publicacion in metadatos_publicaciones.itertuples():
    try:
        ...
        try:
            ...
            print(f'Error en la creacion del archivo temporal: {e}')
        ...
        try:
            ...
            print(f'Error en el enriquecimiento del documento: {e}')
        ...
        try:
            ...
            print(f'Error en el cargar el documento enriquecido: {e}')
        ...
        try:
            ...
            print(f'Error al realizar chunks del documento enriquecido: {e}')
        ...
        for c in chunks:
            try:
                ...
                print(f'Error al generar embedding del chunk: {e}')
            ...
            try:
                ...
                print(f'Error al insertar el chunk y embeddings en la BBDD : {e}')
        try:
            ...
            print(f'Error al generar embedding del resumen: {e}')
        try:
            datos_resumen = {
                # Normalizo la id_publicaciones mediante el dict extraido anteriormente
            'id_publicaciones': publicaciones_id_dict[publicacion.identificador_arxiv],
            ...
            print(f'Error al insertar el resumen y sus embeddings en la BBDD: {e}')

    except Exception as e:
        print(f'Error en el pipeline de extraccion: {e}')
